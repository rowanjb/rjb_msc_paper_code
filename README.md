...
🧐 AR7W_MLE_xsection_monthly_clim.py : copy of above but for monthly climatologies\
⚙️ Argo_gridding_ANHA4 : puts 1D Argo data from mixedlayer.ucsd.edu onto the ANHA4 grid\
⚙️ Argo_uncertainty_calcs.py : calculated (e.g.,) standard deviations of Argo statistics\
...
🏞️ figure_AR7W_MLE_xsection_monthly_clim.py : copy of above but for monthly climatologies\
...
🏞️ figure_LabSea_stability.py : produces figure of stability anomalies\
...
🏞️ filepaths.py : creates .txt's (saved outside this repo) of output files on Graham/Nibi/etc\
...
🧐 stability.py : analyses relating to the stability frequency and its thermal and haline components\
