...
def plot_stratification_figure():
    ...
    ax1.set_ylabel(
        'Convective\nresistance ($PJ$)',
        # r'$\overline{\Omega_{CR}}_{_{DJFMA}}$ ($PJ$)'),
    ...
    ax1.yaxis.grid(True,linewidth=0.1,zorder=-10,alpha=0.25)
    ...
    ax2.yaxis.grid(True,linewidth=0.1,zorder=-10,alpha=0.25)
    ...
    ax3.yaxis.grid(True,linewidth=0.1,zorder=-10,alpha=0.25)
    ...
    ax4.yaxis.grid(True,linewidth=0.1,zorder=-10,alpha=0.25)
